...
class CubeMaker extends CuboidMaker{
    ...
    cube_volume(){return this.length**3};
    cube_surfaceArea(){return 6*(this.length**2)};
}



const cuboid_to_cube = new CubeMaker(4,5,5);
console.log(cuboid_to_cube.cube_volume());
console.log(cuboid_to_cube.cube_surfaceArea());